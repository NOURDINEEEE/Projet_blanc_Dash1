...
def display_value(tabs):
    if tabs == 'Graphe 1' :
        return (fig_GDP_STI_normalized, "Analyse Graphe 1 : " + commentaire_europe_gdp_STI)
    elif tabs == 'Graphe 2' :
...
def display_value(tabs):
    if tabs == 'France' :
        ...
        return ("Conclusion de l'analyse au niveau de la Zone Euro : ", commentaire_europe_conclusion)
    elif tabs == 'Monde' :
